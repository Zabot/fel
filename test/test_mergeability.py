...
def test_missing_reviews(gh_repo, ppr):
    ...
    ppr.base.repo.get_branch().get_protection().required_pull_request_reviews.required_approving_review_count = (
        1
    )
...
def test_missing_status(gh_repo, ppr):
    ...
    ppr.base.repo.get_branch().get_protection().required_status_checks.contexts = [
        "check"
    ]
